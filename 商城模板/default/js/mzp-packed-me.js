...
var MagicZoom_ua='msie';var W=navigator.userAgent.toLowerCase();if(W.indexOf("opera")!=-1){
    ...
    this.version='2.3';this.recalculating=false;this.smallImageCont=MagicZoom_$(smallImageContId);this.smallImage=MagicZoom_$(smallImageId);this.bigImageCont=MagicZoom_$(bigImageContId);this.bigImage=MagicZoom_$(bigImageId);this.pup=0;this.settings=settings;if(!this.settings["header"]){
        ...
        this.loadingCont=document.createElement('DIV');this.loadingCont.style.position='absolute';this.loadingCont.style.visibility='hidden';this.loadingCont.className='MagicZoomLoading';this.loadingCont.style.display='block';this.loadingCont.style.textAlign='center';this.loadingCont.innerHTML=this.settings["loadingText"]+'<br/><images border="0" alt="'+this.settings["loadingText"]+'" src="'+this.settings["loadingImg"]+'"/>';this.smallImageCont.appendChild(this.loadingCont)
  ...
  this.popupSizeX=100;if(this.settings&&this.settings["header"]!=""){
    ...
    prepare:function(){
        function xgdf7fsgd56(vc67){
            ...
            }this.caption=document.createElement('div');if('images:alt'==this.options.captionSrc.toLowerCase()&&''!=(this.smallImg.alt||'')){
            ...
            }else if('images:title'==this.options.captionSrc.toLowerCase()&&''!=(this.smallImg.title||'')){
